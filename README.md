...
- 명령 팔레트에서 무작위 한국어 문구 삽입
- 템플릿 플레이스홀더 `{{daily-saying-kr}}` 자동 치환
- 외부 API 없이 로컬 데이터만 사용
...
플레이스홀더가 포함된 문서를 열면 플러그인이 자동으로 무작위 문구로 바꿉니다.

## 설치

Obsidian 커뮤니티 플러그인 등록 전에는 GitHub Release에서 `main.js`와 `manifest.json`을 내려받아 수동 설치할 수 있습니다.
